...
rSections = 23 #number of blade profiles 
sSections = 21
Np = 101
Ncp = 101
...
for qq in range(len(Xvalues)):
    filename = '../fullWheelStatorOnly/constant/geometry/{}.stl'.format(filenames[qq])
...
blkLen2 = sLEData[0,0] - x0#nose[-1,0]
NbcX2 = 2*(Nbl)
...
f = open('../fullWheelStatorOnly/system/pointData', 'w')
