...
#%%  Generate the stls 
filenames = ['casing', 'hubCut', 'Hub', 'LE', 'TE', 'mPer', 'nVal', 'pVal', 'outlet', 'inlet', 'offsetHub', 'offsetCas']

Xvalues = [Xc, XhC, Xh, Xrle, Xrte, Xm, Xn, Xp, Xo, Xi, XhO, XcO]
Yvalues = [Yc, YhC, Yh, Yrle, Yrte, Ym, Yn, Yp, Yo, Yi, YhO, YcO]
Zvalues = [Zc, ZhC, Zh, Zrle, Zrte, Zm, Zn, Zp, Zo, Zi, ZhO, ZcO]

for qq in range(len(Xvalues)):
    filename = '../fullWheelRotorOnly/constant/geometry/{}.stl'.format(filenames[qq])
...
f = open('../fullWheelRotorOnly/system/pointData', 'w')
